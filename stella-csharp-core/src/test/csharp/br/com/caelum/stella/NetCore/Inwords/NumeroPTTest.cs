...
namespace Caelum.Stella.CSharp.Inwords.Test
{
    ...
    public class NumeroPTTest
    {
        ...
        {
            string extenso = new NumeroPT(-1).Extenso();
        }

        [TestMethod]
        public void ShouldTransform0InWords()
        {
            string extenso = new NumeroPT(0).Extenso();
        ...
        {
            string extenso = new NumeroPT(2).Extenso();
        ...
        {
            string extenso = new NumeroPT(14).Extenso();
        ...
        {
            string extenso = new NumeroPT(53).Extenso();
        ...
        {
            string extenso = new NumeroPT(99).Extenso();
        ...
        {
            string extenso = new NumeroPT(100).Extenso();
        ...
        {
            string extenso = new NumeroPT(101).Extenso();
        ...
        {
            string extenso = new NumeroPT(199).Extenso();
        ...
        {
            string extenso = new NumeroPT(200).Extenso();
        ...
        {
            string extenso = new NumeroPT(201).Extenso();
        ...
        {
            string extenso = new NumeroPT(999).Extenso();
        ...
        {
            string extenso = new NumeroPT(1000).Extenso();
        ...
        {
            string extenso = new NumeroPT(1001).Extenso();
        ...
        {
            string extenso = new NumeroPT(1031).Extenso();
        ...
        {
            string extenso = new NumeroPT(1000150.99).Extenso();
        ...
        {
            string extenso = new NumeroPT(2e6).Extenso();
        ...
        {
            string extenso = new NumeroPT(222).Extenso();
        ...
        {
            string extenso = new NumeroPT(1E21).Extenso();
        ...
        {
            string extenso = new NumeroPT(2E21).Extenso();
